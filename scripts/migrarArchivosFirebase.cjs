// scripts/migrarArchivosFirebase.cjs
/**
 * Script de migración de archivos antiguos de Realtime Database a Firebase Storage.
 * Ejecutar con: node scripts/migrarArchivosFirebase.cjs
 */

const { initializeApp } = require("firebase/app");
const { getDatabase, ref, get, update } = require("firebase/database");
const { uploadFileAndGetURL } = require("./uploadFileAndGetURL.migracion.cjs");
const { app: firebaseApp } = require("./firebase.migracion.cjs");
