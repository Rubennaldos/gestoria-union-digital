// scripts/migrarArchivosFirebase.js
/**
 * Script de migración de archivos antiguos de Realtime Database a Firebase Storage.
 * Ejecutar con: node scripts/migrarArchivosFirebase.js
 */

const { initializeApp } = require("firebase/app");
const { getDatabase, ref, get, update } = require("firebase/database");
const { uploadFileAndGetURL } = require("../src/services/FileStorageService");
const { app: firebaseApp } = require("../src/config/firebase");
